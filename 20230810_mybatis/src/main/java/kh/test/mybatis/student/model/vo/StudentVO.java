...
//	COACH_PROFESSOR_NO	VARCHAR2(20 BYTE)
	...
	public StudentVO(String studentNo, String departmentNo, String studentName, String studentSsn,
			String studentAddress, LocalDateTime entranceDate, String absenceYn, String coachProfessorNo) {
		super();
	...
	public String toString() {
		return "StudentDAO [studentNo=" + studentNo + ", departmentNo=" + departmentNo + ", studentName=" + studentName
